...
class PPO_Autoencoder:
    ...
    def _loss_fn(self, params, traj_batch: Transition, gae, targets, ent_coeff):
        ...
        traj_batch_augmented_belief_states_swapped, _ = jax.vmap(
            self.autoencoder_model.apply, in_axes=(None, 0)
        )(self.autoencoder_params, traj_batch_augmented_belief_states_swapped)
        traj_batch_augmented_belief_state = jnp.swapaxes(
            traj_batch_augmented_belief_states_swapped, 0, 1
        )
